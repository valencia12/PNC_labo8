...
public class ClienteDAOImpl implements ClienteDAO {
	...
	public int ejecutarProcedimientoJdbc(Integer cliente, Boolean estado) {
		...
		Map<String, Object> parameteros = new HashMap<>();
		parameteros.put("P_CLIENTE", cliente);
		parameteros.put("P_ESTADO", estado);
		
		Map<String, Object> out = jdbcCall.execute(parameteros);
